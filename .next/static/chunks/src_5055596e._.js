...
class ApiService {
    ...
    async login(data) {
        try {
            // For demo purposes, mock successful login for @thewebvalue.com emails
            if (data.email.endsWith('@thewebvalue.com') && data.password.length >= 6) {
                const mockUser = {
                    id: '1',
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handleApiError"])(error);
        }
    }
    async register(data) {
        try {
            // For demo purposes, mock successful registration
            if (!data.email.endsWith('@thewebvalue.com')) {
            ...
            return [
                {
                    ...
                    description: 'Create a responsive dashboard with task management features',
                    status: 'In Progress',
                    dueDate: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString(),
                    assignedTo: 'john@thewebvalue.com',
                    assignedBy: 'admin@thewebvalue.com',
    ...
    async createTask(data) {
        try {
            // For demo purposes, return mock created task
            return {
    ...
    async updateTaskStatus(taskId, status) {
        try {
            // For demo purposes, return mock updated task
            return {
                id: taskId,
                title: 'Updated Task',
            ...
            return [
                {
                    id: '1',
                    userId: '1',
                    message: 'New task assigned: Implement Dashboard',
                    type: 'Task',
                    read: false,
                    createdAt: new Date().toISOString()
                },
                {
                    id: '2',
                    userId: '1',
                    message: 'Task completed: User Authentication',
                    type: 'Task',
                    read: true,
...
function AuthProvider({ children }) {
                ...
                "AuthProvider.useEffect.initAuth": async ()=>{
                    try {
                        ...
                        if (token && userData) {
                            ...
                            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].verifyToken();
                            setUser(user);
                        }
                    } catch (error) {
    ...
    const login = async (email, password)=>{
        try {
            setIsLoading(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].login({
                email,
                password
            });
            // Store auth data
    ...
    const register = async (data)=>{
        try {
            setIsLoading(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].register(data);
            toast({
...
_s(AuthProvider, "aBbsSyc6Ti9jIgUl90pugOnw6cE=", false, function() {
    return [
...
__turbopack_context__.s({
    ...
    "generateTimeAgo": (()=>generateTimeAgo),
...
function useNotifications() {
    ...
    const fetchNotifications = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[fetchNotifications]": async ()=>{
            try {
                setIsLoading(true);
                setError(null);
                const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getNotifications();
    ...
    const markAsRead = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[markAsRead]": async (notificationId)=>{
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].markNotificationAsRead(notificationId);
                setNotifications({
    ...
    const markAllAsRead = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[markAllAsRead]": async ()=>{
            try {
                const promises = notifications.filter({
                    "useNotifications.useCallback[markAllAsRead].promises": (n)=>!n.read
                }["useNotifications.useCallback[markAllAsRead].promises"]).map({
                    "useNotifications.useCallback[markAllAsRead].promises": (n)=>markAsRead(n.id)
                }["useNotifications.useCallback[markAllAsRead].promises"]);
...
_s(useNotifications, "Fk//i+SWUNUHkiVZ+O1tZ+/XIG4=");
...
function NotificationBell() {
    _s();
    const { notifications, unreadCount, isLoading, markAsRead, markAllAsRead } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useNotifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotifications"])();
                    ...
                    children: [
                        ...
                        unreadCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "relative inline-flex rounded-full h-5 w-5 bg-red-500 text-white text-xs items-center justify-center",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    ...
                                                    children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useNotifications$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatNotificationTime"])(notification.createdAt)
                                                }, void 0, false, {
                                                    fileName: "[project]/src/components/NotificationBell.tsx",
                                                    lineNumber: 75,
                                                    columnNumber: 21
...
_s(NotificationBell, "myakY91spAjILxiRGUsA38FDwWQ=", false, function() {
    return [
    ...
    const NavLinks = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    href: "/dashboard",
                    className: `${isActive("/dashboard") ? "text-gray-900 border-blue-500" : "text-gray-500 border-transparent hover:text-gray-700 hover:border-gray-300"} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium`,
                ...
                isAdmin && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    href: "/admin",
                    className: `${isActive("/admin") ? "text-gray-900 border-blue-500" : "text-gray-500 border-transparent hover:text-gray-700 hover:border-gray-300"} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium`,
                    onClick: ()=>setIsMobileMenuOpen(false),
                    children: "Admin"
                }, void 0, false, {
                    fileName: "[project]/src/components/Navigation.tsx",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    href: "/profile",
                    className: `${isActive("/profile") ? "text-gray-900 border-blue-500" : "text-gray-500 border-transparent hover:text-gray-700 hover:border-gray-300"} inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium`,
                    onClick: ()=>setIsMobileMenuOpen(false),
                    children: "Profile"
                }, void 0, false, {
                    fileName: "[project]/src/components/Navigation.tsx",
...
_s(Navigation, "bgQw02FXHWtxI+gfRHQwDUDnWKY=", false, function() {
    return [
...
//# sourceMappingURL=src_5055596e._.js.map