...
class ApiService {
    async request(endpoint, options = {}) {
        try {
            const authHeader = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAuthHeader"])();
            const headers = new Headers({
                ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_HEADERS"],
                ...authHeader,
                ...options.headers
            });
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_BASE_URL"]}${endpoint}`, {
                ...options,
                headers
            });
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handleApiError"])(error);
            throw error;
        }
    }
    // Auth endpoints
    async login(credentials) {
        const response = await this.request(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].LOGIN, {
            method: 'POST',
    ...
    async register(userData) {
        const response = await this.request(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].REGISTER, {
            method: 'POST',
    ...
    async verifyToken() {
        const response = await this.request(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].VERIFY_TOKEN);
        return response.data;
    }
    // User endpoints
    async getUserProfile(userId) {
        const response = await this.request(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].USER_PROFILE(userId));
        return response.data;
    }
    ...
    // Task endpoints
    async getTasks() {
        const response = await this.request(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].TASKS);
        return response.data;
    }
    ...
    async updateTaskStatus(taskId, status) {
        const response = await this.request(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].TASK_STATUS(taskId), {
            method: 'PUT',
            body: JSON.stringify({
                status
            })
    ...
    // Project endpoints
    async getProjects() {
        const response = await this.request(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].PROJECTS);
        return response.data;
    }
    ...
    async updateProject(projectId, data) {
        const response = await this.request(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].PROJECT_DETAIL(projectId), {
            method: 'PUT',
            body: JSON.stringify(data)
        });
        return response.data;
    ...
    async getDashboardStats() {
        const response = await this.request(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].DASHBOARD_STATS);
        return response.data;
    }
    // Notification endpoints
    async getNotifications() {
        const response = await this.request(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].NOTIFICATIONS);
        return response.data;
    }
    async markNotificationAsRead(notificationId) {
        await this.request(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].MARK_NOTIFICATION_READ(notificationId), {
            method: 'PUT'
        });
    }
    // Admin endpoints
    async getAllUsers() {
        const response = await this.request(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].USERS);
        return response.data;
    }
    ...
    async deleteUser(userId) {
        await this.request(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].USER_PROFILE(userId), {
            method: 'DELETE'
        });
    }
}
            ...
            const checkAuth = {
                "AuthProvider.useEffect.checkAuth": async ()=>{
                    try {
                        const token = localStorage.getItem("auth_token");
                        if (token) {
                            const userData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].verifyToken();
                            setUser(userData);
                        }
                    } catch (error) {
...
//# sourceMappingURL=src_b6cfd969._.js.map